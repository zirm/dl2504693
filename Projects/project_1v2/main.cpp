...
int main(int argv,char *argc[]){
    ...
    <<"Your comfort choice is the a good old Honda Accord.\nIt's obviously not nearly as fast as the Bentley "
    <<"But the price is far more affordable at just 400 Dollars. This baby will take you home in 12 Events.\n"
    ...
    cin>>dummy;
    cout<<endl<<"You will also have two choices of weapons. A handgun or a shotgun.The handgun is the cheaper choice at 50 dollars.\n"
...
void problem2(){
    ...
    readFromFile(filename,art,SIZE);
    filename = "art4.txt";
    readFromFile(filename,art4,SIZE);
...
void problem5(){
   ...
   string filename = "art.txt";
    ...
    cout<<"Congratulations on your purchase of a Honda Accord and a handgun!\n"
    "Now your have a total of " <<cash<<" Dollars.\n";
